...
public abstract class UserTask<Params, Progress, Result> {
    ...
    protected static int KEEP_ALIVE = 5;
    ...
    public void setListener(IUserTaskListener<Progress, Result> listener){
    	mUserTaskListener = new SoftReference<IUserTaskListener<Progress,Result>>(listener);
    }
    ...
    protected SoftReference<IUserTaskListener<Progress, Result>> mUserTaskListener;
    ...
    public final UserTask<Params, Progress, Result> execute(Params... params) {
        ...
        if(mUserTaskListener != null){
    		IUserTaskListener<Progress, Result> listener = mUserTaskListener.get();
    		if(listener != null){
    			onPreExecute();
    		}
    	}
            ...
            switch (msg.what) {
                case MESSAGE_POST_RESULT:{
                    ...
                    if(result.mTask.mUserTaskListener != null){
                    	IUserTaskListener listener = (IUserTaskListener) result.mTask.mUserTaskListener.get();
                    	if(listener != null){
                    		listener.onPostExecute(result.mData[0]);
                    	}
                	}    
                    break;
            	}
                case MESSAGE_POST_PROGRESS:{
                    ...
                    IUserTaskListener listener = (IUserTaskListener) result.mTask.mUserTaskListener.get();
                	if(listener != null){
                		listener.onProgressUpdate(result.mData);
                	}
                    break;
            	}
